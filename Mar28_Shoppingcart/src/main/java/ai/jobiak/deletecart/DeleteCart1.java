...
@WebServlet("/dcart1")
public class DeleteCart1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(int i=0;i<itemsList.size();i++){
			out.println("<a href='dcart1?item="+itemsList.get(i).getProductId()+"'>Delete Items  :"+itemsList.get(i).getProductId()+"</a></br>");
		}	
		out.print("<hr/>");
