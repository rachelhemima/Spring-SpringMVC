...
/**
 * Servlet implementation class DeleteCartEx
 */
@WebServlet("/delete")
public class DeleteCartEx extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(int i=0;i<itemsList.size();i++){
			out.println("<a href='delete?item="+itemsList.get(i).getProductId()+"'>Add Items  :"+itemsList.get(i).getProductId()+"</a></br>  ");
			out.println("<a href='delete?item="+itemsList.get(i).getProductId()+"@delete"+" '>Delete Item  :"+itemsList.get(i).getProductId()+"</a></br>");
