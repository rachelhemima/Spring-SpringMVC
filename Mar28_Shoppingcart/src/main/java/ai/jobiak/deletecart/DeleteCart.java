...
public class DeleteCart extends HttpServlet {
	...
	out.println("<h3>Select Items To Add into the Cart!!!<h3>");
		for(int i=0;i<itemsList.size();i++){
			out.println("<a href='deletecart?item="+itemsList.get(i).getProductId()+"'>Add Items  :"+itemsList.get(i).getProductId()+"</a></br>");
		}	
		out.print("<hr/>");
 ...
 out.println("<hr/>");
		...
		out.println("<h3>Total Cost of Items::"+total+"</h3>");
		   out.println("<h2><a href='dcart1'>Click to Delete items from cart</h2></a></br>");
	}
}
